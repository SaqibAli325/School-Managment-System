...
import FlotCharts from '../components/Charts/FlotCharts.jsx'
  ...
  return (
    <div className='w-screen h-screen bg-[#F2F2F3]'>
      ...
      <PageContainer>
        ...
        <Header parentTitle="Hi, welcome back!" childTitle="Charts" grandChildTitle="Flot" />
