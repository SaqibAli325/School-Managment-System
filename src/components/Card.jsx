...
const Card = (props) => {
  ...
  return (
    <div style={{ backgroundColor: props.color }} className={`w-full flex justify-start items-center ${isWhiteBg ? 'text-black shadow-sm' : `text-${props.textColor || 'white'}`} gap-4 p-[2em] pr-8 rounded`}>
      {/* Left */}
      {Icon && (
