    ...
    return (
        <div className='w-screen h-screen bg-[#F2F2F3]'>
            ...
            <div className={`absolute right-0 bottom-0 ${windowWidth < 1100 ? (mobileMenuOpen ? 'w-[calc(100vw-250px)]' : 'w-screen') : (sidebarCollapsed ? 'w-[calc(100vw-56px)]' : 'w-[calc(100vw-250px)]')} h-[calc(100vh-65px)] p-4 overflow-y-auto overflow-x-hidden`}>
                ...
                <Header parentTitle="Edit Staff" childTitle="Staff" grandChildTitle="Edit Staff"/>
                ...
                <div className="bg-white rounded shadow-sm p-4 sm:p-6 mt-4">
                    ...
                    <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="flex flex-col gap-2">
                            ...
                            <input type="text" defaultValue="John" placeholder="Enter First Name" className="border border-gray-200 rounded px-[0.95rem] py-1.25 h-[2.7rem] focus:outline-none focus:ring-2 focus:ring-[#6A73FC]/30" />
                        </div>

                        <div className="flex flex-col gap-2">
                            <label className="ml-1 text-[0.875rem] font-medium text-[#312a2a] mb-2">Last Name</label>
                            <input type="text" defaultValue="Doe" placeholder="Enter Last Name" className="border border-gray-200 rounded px-[0.95rem] py-1.25 h-[2.7rem] focus:outline-none focus:ring-2 focus:ring-[#6A73FC]/30" />
                        </div>

                        <div className="flex flex-col gap-2">
                            <label className="ml-1 text-[0.875rem] font-medium text-[#312a2a] mb-2">Email</label>
                            <input type="email" defaultValue="john.doe@example.com" placeholder="Enter Email" className="border border-gray-200 rounded px-[0.95rem] py-1.25 h-[2.7rem] focus:outline-none focus:ring-2 focus:ring-[#6A73FC]/30" />
                        </div>

                        <div className="flex flex-col gap-2">
                            <label className="ml-1 text-[0.875rem] font-medium text-[#312a2a] mb-2">Joining Date</label>
                            <input type="date" defaultValue="2023-01-15" placeholder="Joining Date" className="border border-gray-200 rounded px-[0.95rem] py-1.25 h-[2.7rem] focus:outline-none focus:ring-2 focus:ring-[#6A73FC]/30" />
                        </div>

                        <div className="flex flex-col gap-2">
                            <label className="ml-1 text-[0.875rem] font-medium text-[#312a2a] mb-2">Password</label>
                            <div className="relative">
                                <input type={showPassword ? "text" : "password"} defaultValue="password123" placeholder="Password" className="w-full border border-gray-200 rounded px-[0.95rem] py-1.25 h-[2.7rem] focus:outline-none focus:ring-2 focus:ring-[#6A73FC]/30" />
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="relative">
                                <input type={showConfirmPassword ? "text" : "password"} defaultValue="password123" placeholder="Confirm Password" className="w-full border border-gray-200 rounded px-[0.95rem] py-1.25 h-[2.7rem] focus:outline-none focus:ring-2 focus:ring-[#6A73FC]/30" />
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <input type="text" defaultValue="Senior Administrator" placeholder="Designation" className="border border-gray-200 rounded px-[0.95rem] py-1.25 h-[2.7rem] focus:outline-none focus:ring-2 focus:ring-[#6A73FC]/30" />
                        </div>
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <input type="date" defaultValue="1990-05-20" placeholder="Date of Birth" className="border border-gray-200 rounded px-[0.95rem] py-1.25 h-[2.7rem] focus:outline-none focus:ring-2 focus:ring-[#6A73FC]/30" />
                        </div>

                        <div className="flex flex-col gap-2">
                            <label className="ml-1 text-[0.875rem] font-medium text-[#312a2a] mb-2">Education</label>
                            <input type="text" defaultValue="M.Tech in Computer Science" placeholder="Education" className="border border-gray-200 rounded px-[0.95rem] py-1.25 h-[2.7rem] focus:outline-none focus:ring-2 focus:ring-[#6A73FC]/30" />
                        </div>

                        <div className="flex flex-col gap-2 md:col-span-2">
                            <label className="ml-1 text-[0.875rem] font-medium text-[#312a2a] mb-2">Address</label>
                            <textarea rows="4" defaultValue="123 Main Street, New York, NY 10001" className="border border-gray-200 rounded px-[0.95rem] py-2 focus:outline-none focus:ring-2 focus:ring-[#6A73FC]/30 resize-none"></textarea>
                        </div>
