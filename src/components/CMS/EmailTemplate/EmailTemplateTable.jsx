...
import { RiMailFill, RiArrowUpSLine, RiPencilFill, RiDeleteBinFill, RiArrowLeftSLine, RiArrowRightSLine, RiCheckLine } from "@remixicon/react";

const defaultData = [
    { title: "User Registration", status: "active", modified: "03 Feb, 2024" },
    { title: "User Forgot Password", status: "active", modified: "04 Feb, 2024" },
    { title: "User Activation", status: "active", modified: "05 Feb, 2024" },
    { title: "User Login", status: "active", modified: "06 Feb, 2024" },
    { title: "User Account Locked", status: "active", modified: "07 Feb, 2024" },
];

const EmailTemplateTable = ({ data = defaultData, onEdit, onDelete }) => {
                        ...
                        <table className="w-full text-sm min-w-[650px]">
                            <thead>
                                <tr className="text-left text-gray-800">
                                    <th className="px-5 py-4 font-semibold whitespace-nowrap">Sr.No</th>
                                ...
                                {data.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-5 py-4">
                                            <span className="inline-flex items-center justify-center w-6 h-6 rounded-md bg-[#6A73FC] text-white">
                                                <RiCheckLine size={14} />
                                            </span>
                                        </td>
