...
import { RiFileTextFill, RiArrowUpSLine, RiPencilFill, RiDeleteBinFill, RiArrowLeftSLine, RiArrowRightSLine } from "@remixicon/react";

const defaultData = [
  { title: "Title of first blog post entry", status: "Published", modified: "09 Jan, 2024" },
  { title: "Why Go For A VFX Course?", status: "Published", modified: "13 May, 2024" },
  { title: "Reasons To Choose Animation Courses", status: "Published", modified: "13 Apr, 2024" },
  { title: "Blue Screen Vs Green Screen For VFX", status: "Published", modified: "13 June, 2024" },
  { title: "All About Animation", status: "Published", modified: "13 Apr, 2024" },
];

const BlogTable = ({ data = defaultData, onEdit, onDelete }) => {
