...
import AddEmailTemplateForm from "./AddEmail/AddEmailTemplateForm.jsx";
...
const AddEmail = () => {
  ...
  return (
    <div className="w-screen h-screen bg-[#F2F2F3]">
      ...
      <PageContainer>
        <Header parentTitle="Add Email" childTitle="CMS" grandChildTitle="Add Email" />
        ...
        <div className="pt-4">
          ...
          <AddEmailTemplateForm onSave={handleSave} />
        </div>
