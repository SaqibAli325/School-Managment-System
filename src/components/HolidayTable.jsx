...
const defaultData = [
  { title: "Festival", type: "National Holiday", startDate: "31 July 1998", endDate: "12 August 2021", details: "Lorem Ipsum is simply dummy" },
  { title: "Republic Day", type: "Office Holiday", startDate: "23 August 2005", endDate: "25 May 2019", details: "When an unknown printer took" },
  { title: "Festival", type: "National Holiday", startDate: "15 March 2001", endDate: "28 May 2021", details: "Aldus Page Maker including versions" },
  { title: "Republic Day", type: "Office Holiday", startDate: "31 July 1998", endDate: "12 August 2021", details: "Lorem Ipsum is simply dummy" },
  { title: "Festival", type: "National Holiday", startDate: "15 March 2001", endDate: "28 May 2021", details: "When an unknown printer took" },
  { title: "Republic Day", type: "Office Holiday", startDate: "31 July 1998", endDate: "12 August 2021", details: "Aldus Page Maker including versions" },
  { title: "Festival", type: "Public Holiday", startDate: "23 August 2005", endDate: "25 May 2019", details: "Lorem Ipsum is simply dummy" },
  { title: "Memorial Day", type: "National Holiday", startDate: "15 March 2001", endDate: "28 May 2021", details: "When an unknown printer took" },
  { title: "Republic Day", type: "National Holiday", startDate: "31 July 1998", endDate: "12 August 2021", details: "Aldus Page Maker including versions" },
  { title: "Independence Day", type: "Office Holiday", startDate: "23 August 2005", endDate: "25 May 2019", details: "When an unknown printer took" },
  { title: "Memorial Day", type: "Public Holiday", startDate: "15 March 2001", endDate: "28 May 2021", details: "Lorem Ipsum is simply dummy" },
  { title: "Independence Day", type: "Office Holiday", startDate: "31 July 1998", endDate: "12 August 2021", details: "Aldus Page Maker including versions" },
  { title: "Festival", type: "National Holiday", startDate: "23 August 2005", endDate: "25 May 2019", details: "Aldus Page Maker including versions" },
  { title: "Independence Day", type: "Public Holiday", startDate: "15 March 2001", endDate: "28 May 2021", details: "When an unknown printer took" },
  { title: "Memorial Day", type: "National Holiday", startDate: "31 July 1998", endDate: "12 August 2021", details: "Lorem Ipsum is simply dummy" },
];

const HolidayTable = ({ data = defaultData, onEdit, onDelete, onAddNew }) => {
  ...
  // Search filter - title, type, details me se kahin bhi match kare
    ...
    <div className="pt-4">
      ...
      <div className="bg-white rounded shadow-sm p-4 sm:p-6 w-full overflow-x-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
          <h2 className="text-lg font-semibold text-gray-700">Holiday List</h2>
          <button
          ...
          <table className="w-full min-w-200 text-sm">
            ...
            <tbody>
              ...
              {visibleData.map((item, index) => (
                ...
                >
                  <td className="py-3 px-4 text-[#737b8b]">
                  ...
                  <td className="py-3 px-4 text-[#737b8b] whitespace-nowrap">{item.startDate}</td>
                  <td className="py-3 px-4 text-[#737b8b] whitespace-nowrap">{item.endDate}</td>
                  <td className="py-3 px-4 text-[#737b8b] whitespace-nowrap">{item.details}</td>
