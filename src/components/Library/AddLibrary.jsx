                ...
                <div className="bg-white rounded shadow-sm p-4 sm:p-6 mt-4">
                    ...
                    <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <input type="text" placeholder="Auther Name" className="border border-gray-200 rounded px-[0.95rem] py-1.25 h-[2.7rem] focus:outline-none focus:ring-2 focus:ring-[#6A73FC]/30" />
                        </div>

                        <div className="flex flex-col gap-2">
                            <label className="ml-1 text-[0.875rem] font-medium text-[#312a2a] mb-2">Publisher</label>
                            <input type="text" placeholder="Publisher" className="border border-gray-200 rounded px-[0.95rem] py-1.25 h-[2.7rem] focus:outline-none focus:ring-2 focus:ring-[#6A73FC]/30" />
                        </div>
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <input type="text" placeholder="Price" className="border border-gray-200 rounded px-[0.95rem] py-1.25 h-[2.7rem] focus:outline-none focus:ring-2 focus:ring-[#6A73FC]/30" />
                        </div>
                        ...
                        <div className="flex flex-col gap-2 md:col-span-2">
                            ...
                            <textarea placeholder="Assets Details" rows="4" className="border border-gray-200 rounded px-[0.95rem] py-2 focus:outline-none focus:ring-2 focus:ring-[#6A73FC]/30 resize-none"></textarea>
                        </div>
