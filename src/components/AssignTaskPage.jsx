  ...
  return (
    <div className="bg-gray-100 p-6">
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        {/* Assign Task Table */}
        <div className="w-full lg:w-[70%] bg-white border border-gray-200 rounded p-6">
          <h2 className="text-lg font-semibold text-gray-800 mb-6 pb-5 -mx-6 px-6 border-b border-[gainsboro]">Assign Task</h2>
        ...
        {/* Notifications */}
        <div className="w-full lg:w-[30%] bg-white border border-gray-200 rounded p-6 flex flex-col h-auto lg:h-112.5 mt-4 lg:mt-0">
          <h2 className="text-lg font-semibold text-gray-800 mb-5 pb-5 -mx-6 px-6 border-b border-[gainsboro]">Notifications</h2>
