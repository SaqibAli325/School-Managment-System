...
const DragScrollRow = ({ children }) => {
    ...
    return (
        <div
            ...
            className="flex flex-nowrap gap-6 overflow-x-auto scrollbar-none cursor-grab select-none pb-2 "
        >
            {children}
        </div>
    )
...
const thumbnails = [
    ...
    "https://edumin.dexignlab.com/xhtml/images/tab/3.jpg",
                ...
                <div className="bg-white rounded p-6 mt-6 flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="w-full lg:w-[38%]">
                        <div className="bg-[#F2F2F3] rounded flex items-center justify-center h-[380px] overflow-hidden">
                            <img src={activeImage} alt="School Bag" className=" object-contain" />
                        </div>
                        <div className="flex items-center gap-4 mt-4">
                            {thumbnails.map((thumb, i) => (
                                ...
                                >
                                    <img src={thumb} alt="" className="object-contain" />
                                </button>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="w-full lg:w-[62%]">
                        ...
                        <div className="mt-6">
                            ...
                            <div className="flex flex-wrap items-center gap-3">
                                <div className="inline-flex rounded border border-gray-200 overflow-hidden">
                                    {sizes.map((size, i) => (
                                        <button
                                            ...
                                            className={`w-[55px] h-[42px] text-[13px] font-semibold transition-colors ${i !== 0 ? 'border-l border-gray-200 cursor-pointer' : ''} ${activeSize === size
                                ...
                                <input type="number" name="" id="" value="1" min="1" max="10" className="w-[100px] h-[42px] text-[13px] font-semibold bg-white text-gray-600 rounded border border-[#6a73fa] outline-none pl-4" />

                                <button className="h-[42px] px-4 rounded bg-[#6a73fa] text-white text-[13px] font-semibold flex items-center gap-2 hover:bg-[#5a63e8] transition-colors cursor-pointer">
