                    ...
                    <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="relative">
                                <input type={showPassword ? "text" : "password"} defaultValue="SecurePass123!" placeholder="Password" className="w-full border border-gray-200 rounded px-[0.95rem] py-1.25 h-[2.7rem] focus:outline-none focus:ring-2 focus:ring-[#6A73FC]/30" />
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="relative">
                                <input type={showConfirmPassword ? "text" : "password"} defaultValue="SecurePass123!" placeholder="Confirm Password" className="w-full border border-gray-200 rounded px-[0.95rem] py-1.25 h-[2.7rem] focus:outline-none focus:ring-2 focus:ring-[#6A73FC]/30" />
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <input type="text" defaultValue="Senior Professor" placeholder="Designation" className="border border-gray-200 rounded px-[0.95rem] py-1.25 h-[2.7rem] focus:outline-none focus:ring-2 focus:ring-[#6A73FC]/30" />
                        </div>
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <input type="text" defaultValue="Ph.D. in Computer Science" placeholder="Education Details" className="border border-gray-200 rounded px-[0.95rem] py-1.25 h-[2.7rem] focus:outline-none focus:ring-2 focus:ring-[#6A73FC]/30" />
                        </div>
