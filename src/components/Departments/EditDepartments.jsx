...
const EditDepartment = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        capacity: "150",
        details: "This department focuses on software engineering, artificial intelligence, and data science."
    });
    ...
    return (
        <div className='w-screen h-screen bg-[#F2F2F3]'>
            ...
            <PageContainer>
                ...
                <Header 
                    parentTitle="Edit Department" 
                    childTitle="Departments" 
                    grandChildTitle="Edit Department"
                />

                <div className="bg-white rounded shadow-sm p-4 sm:p-6 mt-4">
                    <div className="border-b border-gray-100 pb-4 mb-6">
                        <h2 className="text-lg font-semibold text-gray-700">Edit Department</h2>
                    </div>
                    ...
                    <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="flex flex-col gap-2">
                            ...
                            <input 
                                ...
                                className="border border-gray-200 rounded px-[0.95rem] py-1.25 h-[2.7rem] focus:outline-none focus:ring-2 focus:ring-[#6A73FC]/30" 
                            />
                        </div>
                        ...
                        <div className="flex flex-col gap-2 md:col-span-2">
                            ...
                            <textarea 
                                ...
                                rows="4" 
                                className="border border-gray-200 rounded px-[0.95rem] py-2 focus:outline-none focus:ring-2 focus:ring-[#6A73FC]/30 resize-none"
                            ></textarea>
                        </div>
